...
add wave -noupdate -format Logic /tb_fir_test_data_coeff_generator/i_clk
add wave -noupdate -format Logic /tb_fir_test_data_coeff_generator/i_rstb
add wave -noupdate -format Logic /tb_fir_test_data_coeff_generator/i_pattern_sel
