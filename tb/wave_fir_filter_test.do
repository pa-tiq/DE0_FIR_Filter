...
add wave -noupdate -format Logic -radix unsigned /tb_fir_filter_test/u_fir_filter_test/w_write_enable
add wave -noupdate -format Logic -radix unsigned /tb_fir_filter_test/u_fir_filter_test/w_data_test
...
add wave -noupdate -format Analog-Step -height 50 -max 63.0 -min -0.0 -radix decimal /tb_fir_filter_test/u_fir_filter_test/fir_output
TreeUpdate [SetDefaultTree]
