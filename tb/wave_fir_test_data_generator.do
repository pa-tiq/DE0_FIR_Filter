...
add wave -noupdate -format Literal -radix decimal /tb_fir_test_data_generator/u_fir_test_data_generator/o_data
add wave -noupdate -format Logic /tb_fir_test_data_generator/u_fir_test_data_generator/o_write_enable
...
add wave -noupdate -format Logic /tb_fir_test_data_generator/u_fir_test_data_generator/w_start_pulse
TreeUpdate [SetDefaultTree]
